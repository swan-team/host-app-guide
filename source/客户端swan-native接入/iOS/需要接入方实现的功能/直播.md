...
## 1.3. 开发指南
* 1、实现SWANLiveProtocol接口

```
@protocol SWANLiveProtocol <NSObject>
...
```
* 2、播放器事件回调通过`SWANLivePlayerDelegate`回传
...
```
#import <SWANLiveProtocol.h>

@interface SWANLiveImplement : NSObject: SWANAdapterBaseImplement <SWANLiveProtocol>
